  ...
  return tool(
    ...
    },
    {
      ...
      description: dedent`
        ...
        You can also specify whether or not the search should be case sensitive, provide an array of glob patterns to ignore certain files or directories prefixed with '!'.
